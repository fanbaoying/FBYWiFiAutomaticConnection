...
{
    NSString *urlencoding = [string stringByRemovingPercentEncoding];
    return urlencoding;
}
...
//    NSString *urlencoding = [string stringByAddingPercentEscapesUsingEncoding:enc];
    NSString *urlencoding = [string stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]];
